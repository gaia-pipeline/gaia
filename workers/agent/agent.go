...
type Agent struct {
	...
	// Pipeline Service
	pipelineService gp.PipelineService
...
func InitAgent(exitChan chan os.Signal, scheduler service.GaiaScheduler, pipelineService gp.PipelineService, store store.GaiaStore, certPath string) *Agent {
	ag := &Agent{
		exitChan:        exitChan,
		scheduler:       scheduler,
		store:           store,
